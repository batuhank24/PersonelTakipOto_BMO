...
public abstract class Model_Main implements Interface_Model {
    ...
    //Tüm parametreleri alan kurucu (constructor)
    ...
    //Sadece Id değerini alan kurucu (constructor)
    public Model_Main(int Id) {
        this.Id = Id;
    }

    //Sadece tablo adı değerini alan kurucu (constructor)
    public Model_Main(String tabloAd) {
        this.tabloAd = tabloAd;
    }

    //Sadece kolon adlarını ve tablo adını değerini alan kurucu (constructor)
